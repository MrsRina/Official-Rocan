...
public class ModuleChatSuffix extends Module {
    public static ValueEnum settingIgnorePrefixes = new ValueEnum("Ignore Prefixes", "IgnorePrefixes", "Ignore specified characters.", Ignore.Yes);
    ...
    public void onSetting() {
        settingIgnoredPrefixes.setEnabled(settingIgnorePrefixes.getValue() == Ignore.Yes);
    }
